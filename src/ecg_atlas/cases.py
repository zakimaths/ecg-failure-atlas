...
CATALOG = {
    "clipping": {
        ...
        "title": "Clipping",
        "short": "Clipping",
        "question": "Amplitude loss under hard clipping",
    ...
    "delay": {
        ...
        "title": "Timing delay",
        "short": "Timing delay",
        "question": "Landmark displacement under a known delay",
    ...
    "aliasing": {
        ...
        "short": "Aliasing",
        "question": "Aliasing of an 80 Hz probe at 100 Hz sampling",
    ...
    "baseline": {
        ...
        "question": "High-pass distortion of the clean reference",
    ...
    "edges": {
        ...
        "short": "Filter edges",
        "question": "Boundary sensitivity to processing order",
